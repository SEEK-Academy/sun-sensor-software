...
{
    internal class ProdSunSensorFrameSource : ISunSensorFrameRealtimeSource
    {
        ...
        public ProdSunSensorFrameSource(UsbSettings usbSettings)
        {
        ...
        private void TryEmitPacket(byte[] buffer, int length)
        {
            try
            {
                ...
                var frame = Frame.Parser.ParseFrom(input);
